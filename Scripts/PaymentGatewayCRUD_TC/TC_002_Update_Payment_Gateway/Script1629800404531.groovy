...
UpdateResponse = WS.sendRequest(findTestObject('PaymentGatewayCRUD/UpdatePaymentGateway', [('ID') : UpdateID, ('PGName') : UpdatePGName]))

WS.verifyResponseStatusCode(UpdateResponse, 200)

println(UpdateResponse.getResponseText())

def jsonS = new JsonSlurper()

def jsonResponse = jsonS.parseText(UpdateResponse.getResponseText())
